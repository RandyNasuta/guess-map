                ...
                <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
                    ...
                    <div className="relative flex items-center space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse">
                        ...
                        {isOpen && (
                            <div
                                ref={dropdownRef}
                                className="absolute left-1/2 top-full -translate-x-1/2 z-50 mt-2 w-48 list-none divide-y divide-gray-100 rounded-lg bg-white text-base shadow-sm dark:divide-gray-600 dark:bg-gray-700"
                                id="user-dropdown"
                            >
