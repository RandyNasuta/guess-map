...
var U = class r2 {
  ...
  mergeProps(e) {
    ...
    t.forEach((s) => {
      ...
      let o = e.props[s], p = n.get().props[s], u = (d, c) => Array.isArray(c) ? [...Array.isArray(d) ? d : [], ...c] : typeof c == "object" && c !== null ? Object.keys(c).reduce((l, h) => (l[h] = u(d ? d[h] : void 0, c[h]), l), { ...d }) : c;
      e.props[s] = u(p, o);
...
function Ie(r4, e, t) {
  ...
  return c(), { forceUpdate: c, createProvider: function() {
    let l = o();
    return { update: (h) => u(l, h), disconnect: () => p(l) };
  } };
}
var f = "nprogress";
var P;
...
function ve2(s, t) {
  ...
  let b2 = (0, import_react9.useCallback)((...n2) => {
    ...
    P2 === "delete" ? Jr.delete(C2, { ...w, data: v2.current(c) }) : Jr[P2](C2, v2.current(c), w);
